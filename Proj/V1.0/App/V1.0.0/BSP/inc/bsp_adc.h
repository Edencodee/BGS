...
/* Sample point range: 10~100 */
#define SAMPLE_POINT_MIN    10U
#define SAMPLE_POINT_MAX    100U

#if (SAMPLE_POINT < SAMPLE_POINT_MIN) || (SAMPLE_POINT > SAMPLE_POINT_MAX)
#error "SAMPLE_POINT out of range (10~100)"
#endif
