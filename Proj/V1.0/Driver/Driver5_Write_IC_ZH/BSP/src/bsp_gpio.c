...
/* ====================== IC Config PIN ================================== */
	...
	gpio_output_options_set(CLK_MODE_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_LEVEL_1, CLK_MODE_PIN);
	...
	gpio_output_options_set(FREQ_CTRL_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_LEVEL_1, FREQ_CTRL_PIN);
	...
	gpio_output_options_set(CLOSE_PLS_PORT, GPIO_OTYPE_PP, GPIO_OSPEED_LEVEL_1, CLOSE_PLS_PIN);
...
//	rcu_ckout0_config(RCU_CKOUT0SRC_CKSYS, RCU_CKOUT0_DIV64);
//	//LS -> PA10
